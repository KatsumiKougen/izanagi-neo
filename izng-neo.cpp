...
namespace color {
    enum { Black=0, Red, Green, Yellow, Blue, Purple, Cyan, White, Bright }; 
}

std::vector<char*> splash = {
        ...
        void scan(){
            for (int y=0;y<max_y;y++){
                for (int x=0;x<max_x;x++)
                    switch (pixel[y][x]){
                        case color::Black:
                            attrset(COLOR_PAIR(2));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Red:
                            attrset(COLOR_PAIR(3));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Green:
                            attrset(COLOR_PAIR(4));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Yellow:
                            attrset(COLOR_PAIR(5));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Blue:
                            attrset(COLOR_PAIR(6));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Purple:
                            attrset(COLOR_PAIR(7));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Cyan:
                            attrset(COLOR_PAIR(8));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::White:
                            attrset(COLOR_PAIR(9));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Black+color::Bright:
                            attrset(COLOR_PAIR(10));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Red+color::Bright:
                            attrset(COLOR_PAIR(11));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Green+color::Bright:
                            attrset(COLOR_PAIR(12));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Yellow+color::Bright:
                            attrset(COLOR_PAIR(13));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Blue+color::Bright:
                            attrset(COLOR_PAIR(14));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Purple+color::Bright:
                            attrset(COLOR_PAIR(15));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::Cyan+color::Bright:
                            attrset(COLOR_PAIR(16));mvprintw(1+y, 1+x, "█");standend();break;
                        case color::White+color::Bright:
                            attrset(COLOR_PAIR(17));mvprintw(1+y, 1+x, "█");standend();break;
                    }
            }
            refresh();
        }
