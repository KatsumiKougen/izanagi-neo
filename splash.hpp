static std::vector<const char*> splash = {
    ...
    "Mr. Linus, you've become part of a bigger FOSS community. You just don't know it yet.",
    "LINUS WAS ABLE TO BUILD THIS KERNEL IN A DORM! WITH A BOX OF SCRAPS!",
    "Me? In a metal tube, deep underground with hundreds of programs\nin the most aggressive hard drive in the server?",
    "Where will you be watching the server consume me from? Oh, that's right, a prison cell. I'll send you a box of pointers.",
    "Oh Linus, are you gonna steal my pointer and sell it?",
    "You, what realm is this? Red Hat? Fedora?",
    "\"What is it?\" \"Power, Doctor. If we figure out how to tap it, maybe unlimited power.\"",
    ...
    "\"Yeah. Big code in a kernel. Take that away, what are you?\"\n\"Uhh, genius, billionaire, playboy, philanthropist.\"",
    "\"I am an sysadmin, you dull program, and I will not be bullied by–\" \"PUNY ADMIN.\"",
    "Nope. I think he was trying to say, \"I want my goddamn file.\"",
    "I'm 14 years old, and I still have a nanny? That was weird.",
    ...
    "Who put the sticks up their USB ports? That is cruel.",
    "\"HE HAS NO RESPECT!\" \"THAT IS ALSO TRUE!\"",
    "Let's see if you can laugh after five or six good memory leaks through your FRICKIN' FACE!",
    "That's exactly why none of you have any friends!\nFive CPU cycles after you meet a process, you're already trying to kill them!",
    "\"What has the server ever done for you? Why would you wanna to save it?!\" \"BECAUSE I'M ONE OF THE IDIOTS WHO LIVES IN IT!\"",
    "When I picked you up as a kid, these boys wanted to run you!\nThey ain't never tasted Kotlin code before! I saved your life!",
    "\"Shit!\" \"Language!\"",
    "This feels weird. This feels wrong.",
    "Anybody remember when I carried a nuke through a wormhole?",
    "Uhhh, have you been juicing? Little vibranium cocktail? You're looking... I don't wanna say puffy...",
    "What? Dude shows up dressed like a cat and you don't wanna know more?",
    "Alright. I've run out of patience. Underoos!",
    "You're gonna show me how to punch? Okay. Show me how to...",
    ...
    "It’s how memory management works, you stupid raccoon.",
    "Right. And, if it's anything other than specifically being decapitated by a doorway, I win.",
    "Why? My father would tell the story of him impregnating my mother every winter solstice.",
    "I don't know what Cheers is!",
    "I'm gonna make some weird shit.",
    "Well, of course I have issues! THAT'S MY FREAKING ADMIN!!!",
    "I'm Mary Poppins, y'all!",
    "What?! No, no, no, I don't wanna kill anybody!",
    "Previously on \"Peter Screws the Pooch\", I tell you to stay away from this.",
    "YEEEEES! We know each other! He's a friend from work!",
    "I have been falling...FOR 30 CPU CYCLES!",
    "Tell me, Brother: What were you the God of, again?",
    "\"Linux, son of Linus\". \"Windows, son of ... a bitch! You're still alive?\"",
    "Darling, you have no idea what's possible!",
    "\"I've never met this man in my life.\" \"He's my brother!\"",
    "We are not doing \"Get Help\"!",
    "DID SHE JUST SAY THE SYSADMIN USES IT FOR ORGIES?!",
    "Just for once in your life: Don't. Smash.",
    "I must! I must right these wrongs.",
    "If you don't believe me, you ask your friend what his program is made of.\nWhat his header files are made of.",
    "Son, we have entertained this charlatan for too long. Reject his pull request.",
    "I never yielded! And as you can see: I am not dead!",
    "\"Would you kill me, my love?\" \"For the system? Without question!\"",
    "Wakanda Forever!",
    "Guys. Guys. Okay, seriously, don't joke around. Bring me up! Let's go! GUYS!",
    "\"How many did we win?\" \"One.\"",
    "Evacuate the directory. Engage all defenses. And get this man a pointer.",
    "Up, General! Up! This is no place to die.",
    "You should've gone for the head.",
    "Oh, no. Motherf–",
    "In order to take the source code, you must lose that which you love. A pointer, for a pointer.",
